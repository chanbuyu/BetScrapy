...
class ScrapyseleniumPipeline:
    ...
    def process_item(self, item, spider):
        ...
        sql = '''
                ...
                '''
        values = (
        item['time'], item['league'], item['host'], item['guest'], item['quarter'], item['gameTime'], item['hostScore'],
        item['guestScore'], item['bigSmall'], item['bigOdds'], item['smallOdds'], item['firstQuarter'],
        item['firstHalf'], item['thirdQuarter'])
        try:
