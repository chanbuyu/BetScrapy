import os,pickle, psutil,logging
import win32api
...
class MyFox():
    '''目的：不需要每次都重新打开浏览器'''
    def __init__(self):
        self.file=r'C:\python3\Lib\site-packages\selenium\webdriver\firefox\params.data'
        self.gecko=r'C:\python3\Scripts\geckodriver.exe'
